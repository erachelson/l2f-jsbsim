...
public:
  ...
  /** WARNING!! This Function is not part of the original JSBSim. Was created by Sreekanth.
      This function sets the simulation stating time, end time and delta_T
      @param ts is the starting time of simulation in seconds
      @parm tend is the end time of simulation in seconds
      @param dt is the delta_T or the increment time of the simulation.  */
  void SetSimtime(double ts, double tend, double dt);
  ...
  /** WARNING!! This Function is not part of the original JSBSim. Was created by Sreekanth.
      This function returns the simulation endtime  */  
...
private:
  ...
  string CFGVersion;
  string Release;
  double StartTime;//variable created by Sreekanth not part of original JSBSim
  double EndTime;//variable created by Sreekanth not part of original JSBSim  
