...
public:
  ...
  void SetWindfield(string filename); //not part of the original code. Created by Sreekanth.
  
protected:
  
  Windfield* windfld;//not part of the original code. Created by Sreekanth.
