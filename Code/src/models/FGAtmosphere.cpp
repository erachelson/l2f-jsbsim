...
//  SetTurbType( ttCulp );
  ...
  windfld = 0;//not part of the original code. Created by Sreekanth!
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
void FGAtmosphere::SetWindfield(string filename)
// WARNING!! This function is not part of the original JSBSim
// This function sets the Windfield based on the input file name given by @param1
{
windfld = new Windfield(filename);
}
...
bool FGAtmosphere::Run(void)
{
  ...
  if(windfld!=0){
	...
	time=FDMExec->GetPropertyValue("sim-time-sec");
  
  	w=windfld->calcWind(x,y,z,time);
  	SetWindNED(w[0]*3.28084,w[1]*3.28084,-w[2]*3.28084); // 3.28084 is conversion from m/s to fps
  }
